...
fn copy_resource_file_to_output(version: String){
    ...
    let file_paths = vec![
        FilePath {file_path:format!("shared/data_collect/{version}/WinDataCollect.dll"), target_path:"WinDataCollect.dll"},
        FilePath {file_path:format!("shared/md/{version}/thostmduserapi_se.dll"), target_path:"thostmduserapi_se.dll"},
        FilePath {file_path:format!("shared/td/{version}/thosttraderapi_se.dll"), target_path:"thosttraderapi_se.dll"}
    ];
